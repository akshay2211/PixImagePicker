...
- 🎥 **Video Support** - Capture and pick videos seamlessly
- ⚙️ **Highly Configurable** - Customize ratio, count, mode, and more
- 🚀 **Performance Optimized** - Minimal APK size impact and fast startup
- 📱 **Modern Android** - Built with Kotlin and follows Android best practices
- 🎨 **Themeable** - Customize colors to match your app
...
If you find Pix useful, please consider:

- ⭐ [Starring on GitHub](https://github.com/akshay2211/PixImagePicker)
- ☕ [Buy me a coffee](https://www.paypal.me/akshay2211)
- 💰 [Become a backer](https://opencollective.com/piximagepicker#backers)